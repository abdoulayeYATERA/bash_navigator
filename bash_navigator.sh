...
NOTES
   ...
   Configuration:
      ...
      Configuration example:
              _BASH_NAV_HIST_DB_FOLDER="/tmp/bash_navigator"
...
_bash_nav_add_to_hist() {
  ...
  if [ "$_bash_nav_current_index_nav_hist" -gt "$_bash_nav_hist_db_max_size" ]; then
    local rezised_bash_nav_db
    rezised_bash_nav_db=$(tail -n "$_bash_nav_hist_db_max_size" "$_bash_nav_db")
...
# get alias config
_BASH_NAVIGATOR_BACK=${_BASH_NAVIGATOR_BACK:-bb}
_BASH_NAVIGATOR_FORWARD=${_BASH_NAVIGATOR_FORWARD:-bf}
_BASH_NAVIGATOR_SHOW_HISTORY=${_BASH_NAVIGATOR_SHOW_HISTORY:-bh}
_BASH_NAVIGATOR_JUMP=${_BASH_NAVIGATOR_JUMP:-bj}
_BASH_NAVIGATOR_JUMP_TO_FIRST=${_BASH_NAVIGATOR_JUMP_TO_FIRST:-bbb}
_BASH_NAVIGATOR_JUMP_TO_LAST=${_BASH_NAVIGATOR_JUMP_TO_LAST:-bff}
_BASH_NAVIGATOR_HELP=${_BASH_NAVIGATOR_HELP:-bhelp}

# set aliases

eval " alias ${_BASH_NAVIGATOR_BACK}='_bash_nav_hist_back 2>&1'" > /dev/null
eval " alias ${_BASH_NAVIGATOR_FORWARD}='_bash_nav_hist_forward 2>&1'" > /dev/null
eval " alias ${_BASH_NAVIGATOR_SHOW_HISTORY}='_bash_nav_show_hist 2>&1'" > /dev/null
eval " alias ${_BASH_NAVIGATOR_JUMP}='_bash_nav_hist_jump 2>&1'" > /dev/null
eval " alias ${_BASH_NAVIGATOR_JUMP_TO_FIRST}='_bash_nav_hist_jump_to_first 2>&1'" > /dev/null
eval " alias ${_BASH_NAVIGATOR_JUMP_TO_LAST}='_bash_nav_hist_jump_to_last 2>&1'" > /dev/null
eval " alias ${_BASH_NAVIGATOR_HELP}='_bash_nav_hist_help 2>&1'" > /dev/null
